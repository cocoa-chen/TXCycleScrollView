#
#  Be sure to run `pod spec lint TXCycleScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "陈爱彬"
  # s.authors            = { "陈爱彬" => "136998328@qq.com" }
  # s.social_media_url   = "http://twitter.com/陈爱彬"
